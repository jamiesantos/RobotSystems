...
from picarx_actions import drive_time
...
def maneuver_k_turn(px: Picarx, start_left=True, speed=25):
    ...
    if start_left:
        ...
        drive_time(px, speed=int(speed * 0.6), steering_angle=30, duration=0.6, forward=True)
    else:
...
def print_help():
    ...
    print("  p - parallel park left")
    print("  P - parallel park right")
    print("  k - three-point turn (start left)")
